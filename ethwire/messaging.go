...
const (
	...
	MsgChildGetBlockTy = 0x30
	MsgChildBlockTy    = 0x31
	MsgChildGetHashTy  = 0x32
	MsgChildHashTy     = 0x33
...
var msgTypeToString = map[MsgType]string{
	...
	MsgChildGetBlockTy: "Get block (child)",
	MsgChildBlockTy:    "Block (child)",
	MsgChildGetHashTy:  "Get hash (child)",
	MsgChildHashTy:     "Hash (child)",
}
